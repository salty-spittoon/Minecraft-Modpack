...
Name        "Salty Spittoon Minecraft Modpack Installer 1.21.11"        
OutFile     "Salty Spittoon Minecraft Modpack Installer 1.21.11.exe"
Icon        "icon.ico"
UninstallIcon "icon.ico"

VIProductVersion                 "1.21.11.0"
...
VIAddVersionKey FileVersion      1.21.11.0
...
MessageBox MB_OK 'Salty Spittoon Minecraft Modpack Installer copies our current mods, resource packs, and shaders to your .minecraft folder. Fabric mod loader will be installed and there will be a new profile for you to use in the Minecraft Launcher called, "fabric-loader-1.21.11"'
...
WriteRegStr HKLM "${UNINST_KEY}" "DisplayVersion" "1.21.11"
